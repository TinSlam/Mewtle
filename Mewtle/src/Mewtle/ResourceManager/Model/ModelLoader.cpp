...
namespace Mewtle{
	void ModelLoader::loadTexturedObj(const char* path, GLfloat** vbo, int* vboLength, short** ibo, int* iboLength, float* width, float* height, float* depth, int** materialsIndecies, int* materialsNumber){
